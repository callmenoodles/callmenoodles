...
## :computer: Other
HTML, CSS, C, C++, C#, Unity, GDScript, Java, Markdown, PHP, R, Python, Rust, Tailwind, SASS, jQuery, Electron, Git, Nginx, Strapi, SQLite, MySQL, MongoDB, Firebase, Scala, Rascal, MATLAB, x86 Assembly, Haskell, Visual Basic, Lean.
